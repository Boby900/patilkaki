...
const Hero = () => {
  return (
    <div className="flex flex-col  bg-slate-800 text-white h-screen md:h-screen">
        <h2 className=" p-2 font-bold text-center ml-8 pt-8 pl-16 text-lg"><Link href={"/founder"}>Growth School</Link> </h2>
        <div className="flex md:flex-row justify-around md:pr-2 md:mt-16 p-4 md:p-2 flex-col">
            ...
            <div className="profile p-2 m-2  translate-y-16 bg-slate-600 ">
            <p className="p-1 m-1">Welcome to Growth School</p>
            <Link href={'/becoming'}> 
            <Image className="pl-4 "  src={'https://img.freepik.com/free-photo/pug-dog-isolated-white-background_2829-11416.jpg?w=240&t=st=1707725172~exp=1707725772~hmac=78b2a596ade79a604948d0f2799daf0bfbb3a50b0bcb96153f1b1f83b56acb4a'} alt="dog" width={200} height={200}/>
            </Link>
            </div>
        </div>
    </div>
